...
public class DBAdapter {
    ...
    public long insertClass(String Code, int Count)
    {
        ...
        Log.i(TAG, "INSERTING A class COUNT RECORD");
        ContentValues initialValues = new ContentValues();
        initialValues.put(KEY_CODE, Code);
    ...
    {
        Log.i("Mayank", "GETTING STUDENT RECORD by name");
        Cursor mCursor =
    ...
    {
        Log.i("Mayank", "GETTING STUDENT RECORD count");
        Cursor mCursor =
    ...
    {
        Log.i("Mayank", "GETTING STUDENT RECORD by code");
        Cursor mCursor =
    ...
    {
        Log.i("Mayank", "GETTING STUDENT RECORD total");
        Cursor mCursor =
                db.query(true, DATABASE_TABLE3, new String[] {
                                KEY_ROWID,
                                KEY_CODE,
    ...
    {
        Log.i("Mayank", "GETTING STUDENT RECORD by id");
        Cursor mCursor =
                db.query(true, DATABASE_TABLE2, new String[] {
                                KEY_ROWID,
                                KEY_SNAME,
    ...
    public void deleteStudentRecord(int id){
        Log.i("Mayank", "Trying To Delete Record");
